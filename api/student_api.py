...
3. Используй $...$ для формул в тексте
4. Используй $$...$$ для вынесенных формул
5. Для дробей пиши \\frac{{числитель}}{{знаменатель}} с двойными фигурными скобками
6. Не используй списки, маркеры, звёздочки
7. Пиши связным текстом с выделением шагов
