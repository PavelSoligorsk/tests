...
3. Выражения в тексте оформляй как $...$ (например, $c^2$)
4. Формулы и вычисления формул выноси на отдельную строку с 
$$
...
$$ (центрирование, с новой строки. до и после блока пустая строка, как в примере ниже)
