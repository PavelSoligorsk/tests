...
2. Объясни подход простыми словами, используя $...$ и $$...$$ для всех формул.
3. Если есть варианты — научи исключать неверные.
4. Дай формулу или правило, которое нужно применить, оформляя их в $...$ или $$...$$.
5. 3-5 предложений на русском языке.
6. НЕ пиши ответ. НЕ решай до конца.

Пример правильного оформления:
"Вспомни формулу корней квадратного уравнения $ax^2 + bx + c = 0$:
